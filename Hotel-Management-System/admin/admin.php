...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src=" ">&nbsp&nbsp&nbsp Room Booking</li>
            <li class="pagebtn"><img src=" ">&nbsp&nbsp&nbsp Payment</li>            
            <li class="pagebtn"><img src=" ">&nbsp&nbsp&nbsp Rooms</li>
            <li class="pagebtn"><img src=" ">&nbsp&nbsp&nbsp Staff</li>
        </ul>
    </nav>
